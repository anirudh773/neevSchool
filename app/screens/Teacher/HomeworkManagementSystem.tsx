...
const TeacherHomeworkManager: React.FC = () => {
  ...
  const loadSubjectsData = async () => {
    try {
      ...
      const response = await fetch(
        `https://neevschool.sbs/school/getSchoolSubjects?schoolId=${schoolId}`,
        {
          headers: {
  ...
  const fetchHomeworkList = async () => {
    try {
      ...
      const response = await fetch(
        `https://neevschool.sbs/school/getHomeWork?schoolId=${schoolId}&sectionId=${selectedSectionId}&teacherId=${teacherId}`,
        {
          headers: {
            'Content-Type': 'application/json'
          }
  ...
  const handleCreateHomework = async (): Promise<void> => {
    ...
    try {
      ...
      const response = await fetch('https://neevschool.sbs/school/createHomeWork', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const fetchHomeworkStats = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://neevschool.sbs/school/getHomeworkStats?schoolId=${schoolId}&sectionId=${selectedSectionId}&classId=${selectedClassId}`,
        {
          headers: {
            'Content-Type': 'application/json'
          }
