  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Class Admission</Text>
        <Text style={styles.subtitle}>
          Select a class to view students or add new admissions
        </Text>
      </View>
              ...
              <View style={styles.sectionInfoContainer}>
                {selectedClass && leastPopulatedSection ? (
                  <>
                    ...
                    {/* Only render the FlatList if not navigating */}
                    {!isNavigating ? (
                      <FlatList
                        // Important: use a unique key prop to force remount when class changes
                        ...
                        removeClippedSubviews={false} // Important to prevent view manipulation issues
                      ...
                      // Show a simple loader when navigating
                      <View style={styles.loaderContainer}>
                        <ActivityIndicator size="small" color="#4A90E2" />
                      </View>
                    )}
