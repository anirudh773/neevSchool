    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.infoSection}>
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoRow}>
            <FontAwesome name="graduation-cap" size={20} color="#3498db" />
            <View style={styles.infoTextContainer}>
              <Text style={styles.infoLabel}>Class</Text>
              <Text style={styles.infoValue}>{profile?.class || 'Not assigned'}</Text>
            </View>
          </View>
          ...
          <View style={styles.infoRow}>
            ...
            <View style={styles.infoTextContainer}>
              ...
              <Text style={styles.infoValue}>{profile?.section || 'Not assigned'}</Text>
            </View>
          </View>
        </View>
      </View>
